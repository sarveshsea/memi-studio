...
export const WORKBENCH_COPY = {
  ...
  rightPaneTabs: [
    ...
    { id: "design-audit", label: "Design Health", shortLabel: "Health", group: "utility", icon: "check", iconOnly: false },
  ...
  actionRegistry: [
    ...
    { id: "right-pane.tab.design-audit", label: "Health", kind: "local", surface: "cockpit" },
