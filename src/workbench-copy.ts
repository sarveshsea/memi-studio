  ...
  starterPrompts: [
    {
      label: "Audit UI",
      shortLabel: "Audit",
      template: "Audit this UI for layout, spacing, accessibility, and design-system drift. Return findings, fixes, and verification steps.",
      action: "audit",
      chatMode: "review",
      permissionMode: "plan",
      icon: "review",
    },
    {
      label: "Research page",
      shortLabel: "Research",
      template: "Research the current page and summarize user goals, friction points, comparable patterns, and next UX moves.",
    ...
    },
    {
      ...
      shortLabel: "Tokens",
      template: "Extract design tokens and component patterns from the current workspace, then report gaps and suggested token names.",
      action: "design-doc",
      chatMode: "research",
      permissionMode: "plan",
      icon: "system",
    },
    {
      label: "Write spec",
      shortLabel: "Spec",
      template: "Write an implementation-ready spec for the selected UI/workbench change, including behavior, states, tests, and acceptance criteria.",
      action: "design-doc",
      chatMode: "ideate",
      permissionMode: "plan",
      icon: "packet",
    },
    {
      label: "Review diff",
      shortLabel: "Review",
      template: "Review the current diff for UX regressions, test gaps, formatting issues, and release blockers.",
      action: "audit",
      chatMode: "review",
      permissionMode: "plan",
      icon: "review",
