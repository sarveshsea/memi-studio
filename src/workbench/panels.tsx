...
// Workbench panels: composer surfaces (attachments, chat quality, creation),
// output tabs, context rail, activity timeline, trace + memory panels, and the
// input-mode switcher. This is the tightly-coupled core panel cluster.
...
import { compactStatusLabel, deriveChatFollowUps, deriveVerificationSignals } from "./shared";
import { projectSessionNavItem } from "./sidebar";
